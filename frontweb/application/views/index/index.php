...
<table class="table  table-striped  table-bordered table-condensed">
    <tr class="info">
        <th>
            <center>数据库版本分布</center>
        </th>
        <th>
            <center>数据库连接状态</center>
        </th>
        <th>
            <center>数据库复制状态</center>
        </th>
    </tr>
    <tr style="font-size: 13px;" class="">
        <td>
            <div id="mysql_version" style="margin-top:5px; margin-left:0px; width:420px; height:300px;"></div>
        </td>
        <td>
            <div id="mysql_status" style="margin-top:5px; margin-left:0px; width:420px; height:300px;"></div>
        </td>
        <td>
            <div id="mysql_replication" style="margin-top:5px; margin-left:0px; width:420px; height:300px;"></div>
        </td>
    </tr>
...
<div class="row">
    <div class="span6">
        <table class="table table-bordered table-striped">
            ...
            <tr class="error">
                ...
                <th colspan="6">
                    <div class="text-center">检测信息</div>
                </th>
            </tr>
            </thead>
            <tbody>
    ...
    <div class="span6">
        <table class="table table-bordered table-striped">
            ...
            <tr class="error">
                <th colspan="7">
                    <div class="text-center">最新告警信息</div>
                </th>
            </tr>
            </thead>
            <tbody>
